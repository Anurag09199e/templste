      ...
      <div>
        ...
        <div className="relative h-52 rounded-2xl overflow-hidden mb-5">
          ...
          <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-white text-xs font-semibold">
            <span className="flex items-center gap-1 bg-slate-900/80 backdrop-blur-sm px-2.5 py-1 rounded-lg">
              <Clock className="w-3.5 h-3.5 text-amber-400" /> {course.durationHours} Hours ({course.durationWeeks} wks)
            </span>
        ...
        <div className="space-y-2 mb-4">
          ...
          <h3 className="text-xl font-extrabold font-heading text-slate-900 dark:text-white group-hover:text-amber-500 transition-colors">
            {course.title}
          </h3>

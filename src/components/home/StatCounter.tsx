  ...
  return (
    <section className="py-12 relative z-20 -mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card rounded-3xl p-8 sm:p-10 border border-amber-500/30 shadow-2xl bg-[#f5f0e6] dark:bg-slate-900/90 backdrop-blur-2xl grid grid-cols-2 md:grid-cols-4 gap-8">
          {STATS.map((stat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="text-center space-y-2 border-r last:border-r-0 border-slate-200 dark:border-slate-800 pr-4"
              >
                ...
                <h3 className="text-3xl sm:text-4xl font-extrabold font-heading text-[#200e4f] dark:text-white tracking-tight">
